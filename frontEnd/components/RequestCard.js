  ...
  return (
    <View style={styles.RequestCardContainer}>
      ...
      <View style={styles.innerContent}>
        ...
        {showIncoming ? (
          <Text style={styles.youRequestedGreen}>REQUESTED</Text>
        ) : (
...
const styles = StyleSheet.create({
  ...
  titleGreen: { fontSize: 22, color: mainGreen.mainGreen, fontWeight: "600" },
  owner: { fontSize: 16 },
  ...
  youRequested: { fontSize: 12, color: mainRed.mainRed, fontWeight: "600" }
});
